...
test("Test POST /submissions with right data", async () => {
	let reviewTest = {
	  ...
	  "exam_id": 2,
	  "mark": 10,
	  "answer": [{"text": "vero", "correct": true},{"text": "La Gioconda", "correct": false},{"text": "Questa è una risponsa ad una domanda aperta", "correct": true}]
	};
...
test("Test POST /submissions with wrong anwser data", async () => {
	let reviewTest = {
	  ...
	  "exam_id": 2,
	  "mark": 10,
	  "answer": [{"text": 32, "correct": true},{"text": "La Gioconda", "correct": "false"},{"text": "Questa è una risponsa ad una domanda aperta", "correct": "notabool"}]
	};
	let response = await fetch(`${path}/submissions`, {
		method: 'POST',
		body: JSON.stringify(reviewTest),
